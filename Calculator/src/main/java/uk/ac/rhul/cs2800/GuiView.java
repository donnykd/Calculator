 ...
 * 
 *         The view in JavaFX filled with all the FXML details.
 *
 */
public class GuiView implements ViewInterface {
  ...
  /**
   * Allows only digits, decimal points and operators to be pressed.
   * 
   * @param event the character recently pressed.
   */
  @FXML
  ...
  /**
   * Retrieves the expression needed for another class.
   * 
  ...
  /**
   * Sets the answer after evaluation.
   * 
   * @param the answer to be set.
   */
  @Override
  ...
  // Taken Dave's code in MVC-separated to create this method.
  /**
   * Allows observer to be added to choose how to handle the calculation.
   *
   * @param f observer being notified.
   */
  @Override
  ...
  /**
   * Allows observer to be added to choose which type to calculate with.
   *
   * @param L observer being notified.
   */
  @Override
